...
loaded_model_LR = pickle.load(open('C:/Users/Sithum/Desktop/SLIIT/Y3S1/Fundamentals of Data Mining/DiabetaPro/trained_model_using_LR.sav','rb'))

# loading the saved scaler
loaded_scaler = pickle.load(open('C:/Users/Sithum/Desktop/SLIIT/Y3S1/Fundamentals of Data Mining/DiabetaPro/standard_scaler.sav','rb'))


def diabetes_prediction_LR(input_data):
...
def main():
    ...
    if selected == 'Summary Statistics':
        diabetes_df = pd.read_csv('C:/Users/Sithum/Desktop/SLIIT/Y3S1/Fundamentals of Data Mining/DiabetaPro/diabetes_prediction_dataset.csv')
    ...
    if selected == 'Diabetes Prediction':
        ...
        accuracy = accuracy_score(Y_test, loaded_model_LR.predict(X_test))
        ...
        if st.button("Checkup Result"):
            diagnosis_LR = diabetes_prediction_LR([gender_code,age,hypertension_code, heart_disease_code,smoking_history_code,bmi,hba1c_level,blood_glucose_level])
            
        st.success(diagnosis_LR)
